/* global getActiveTabUrl, guid, hideBrowserActionPopup, loadLocalizedResources, localizedPhrases, resizePopup, getSource */
'use strict';
...
function localize(doc) {
    ...
    for (var i = localizables.length - 1; i >= 0; i--) {
        ...
        localized = localizedPhrases[localizable.innerHTML.trim()];
        if (localized) {
            localizable.innerHTML = localized;
        }
    }
}
